                    ...
                    <fieldset id="shipping" class="mt-30">
                        ...
                        <div class="row form-row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input id="email" name="email" type="text" class="form-control required{{ $errors -> has('email') ? ' is-invalid error' : '' }}" />
                                @if($errors -> has('email'))
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input id="phone" name="phone" type="text" class="form-control required{{ $errors -> has('phone') ? ' is-invalid error' : '' }}" />
                                @if($errors -> has('phone'))
                                    <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <input id="address1" name="address1" type="text" class="form-control required{{ $errors -> has('address1') ? ' is-invalid error' : '' }}" placeholder="Address 1" />
                                @if($errors -> has('address1'))
                                    <div class="invalid-feedback">
                                        <strong>{{ $errors -> first('address1') }}</strong>
                                    </div>
                                @endif
                                <input id="address2" name="address2" type="text" class="form-control mt-10{{ $errors -> has('address2') ? ' is-invalid error' : '' }}" placeholder="Address 2" />
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input id="city" name="city" type="text" class="form-control required{{ $errors -> has('city') ? ' is-invalid error' : '' }}" />
                                @if($errors -> has('city'))
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input id="state" name="state" type="text" class="form-control required{{ $errors -> has('state') ? ' is-invalid error' : '' }}" />
                                @if($errors -> has('state'))
                                    <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input id="zip" name="zip" type="text" class="form-control required{{ $errors -> has('zip') ? ' is-invalid error' : '' }}" />
                                @if($errors -> has('zip'))
                                    <div class="invalid-feedback">
